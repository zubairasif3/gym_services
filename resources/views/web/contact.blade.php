...
@section('title', __('web.contact.title'))
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5">
                    ...
                    <h2 class="text-white">{{ __('web.contact.heading') }}</h2>
                    <p class="text mb0 text-white">{{ __('web.contact.subtitle') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
            <div class="col-lg-6">
                <div class="position-relative mt40">
                    <div class="main-title">
                        <h4 class="form-title mb25">{{ __('web.contact.keep_touch') }}</h4>
                    </div>
                    <div class="iconbox-style1 contact-style d-flex align-items-start mb30">
                        ...
                        <div class="details">
                            <h5 class="title">{{ __('web.contact.email') }}</h5>
            ...
            <div class="col-lg-6">
                <div class="contact-page-form default-box-shadow1 bdrs8 bdr1 p50 mb30-md bgc-white">
                    <h4 class="form-title mb25">{{ __('web.contact.form_title') }}</h4>
                    <p class="text mb30">{{ __('web.contact.form_text') }}</p>
                    <form action="#" class="form-style1">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb20">
                                <label class="heading-color ff-heading fw500 mb10" for="">{{ __('web.contact.name') }}</label>
                                <input type="text" class="form-control" placeholder="Ali">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb20">
                                <label class="heading-color ff-heading fw500 mb10" for="">{{ __('web.contact.email') }}</label>
                                <input type="email" class="form-control" placeholder="Tufan">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb20">
                                <label class="heading-color ff-heading fw500 mb10" for="">{{ __('web.contact.messages') }}</label>
                                <textarea name="" id="" cols="30" rows="6" placeholder="{{ __('web.contact.description') }}"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="">
                                <a class="ud-btn btn-thm" href="{{ route('web.contact') }}">{{ __('web.contact.send') }}<i class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    </form>
